...
exports.handler = async (event) => {
  ...
  try {
    ...
    params.append('success_url', `${SITE}/page-chanson?id=${encodeURIComponent(token)}&upsell_ok=1`);
    params.append('cancel_url',  `${SITE}/page-chanson?id=${encodeURIComponent(token)}`);
